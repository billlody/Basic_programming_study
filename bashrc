...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/yzheng/quantlib/quantlib/lib
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/yzheng/boost/boost/lib
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/opt/3rd/boost/lib
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/yzheng/Downloads/mlpack/build/lib/
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/opt/3rd/alglib/lib
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/yzheng/Otherlib/yaml-cpp/build/
...
alias simsum="/home/yzheng/simsum/simsum-py2.7"
alias cmake="/home/yzheng/cmake/bin/cmake"

HOMEP="/home/yzheng/Personal"
HOMEDW="/home/yzheng/Downloads"
HOMEL="/home/yzheng/Otherlib"
